...
| 18 Simulation | Production normal approximation; separate mean-constrained margin and joint-score experiments with settlement constraints; fixed joint evaluation against an overdispersed Gaussian reference | Validate tails/key numbers and joint scores before promotion; joint-score improvement remains inconclusive and some secondary scores worsen |
