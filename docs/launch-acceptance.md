...
Latest completed hosted checkpoint: source `86558e786be4f13ff909f724f74095311b731e29` passed [verification 34604622114](https://github.com/tosterman/nfl-intelligence/actions/runs/34604622114). This includes historical big-play and inside-20 comparisons, including no-forecast pages, retained-data replay, browser-tested mobile/desktop layouts, production build and dependency checks. Subsequent source `72ccc74` adds the experimental planned odds collector; all 137 application tests and TypeScript checks passed locally, while hosted run 34604983536 was still running at this inspection. Development-branch changes are not the public edition.
...
| 12 Matchup | Opposing efficiency profiles plus retained, reproducible 2025 big-play and inside-20 offense/defense comparisons with sample sizes; conversion and possession-phase corrections independently reviewed. Rate-product model interaction experiment remains rejected | Historical descriptive comparisons are not validated nonlinear scheme, trench or player effects; numerical integration still requires prospective evidence |
