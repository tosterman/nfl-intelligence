...
| 14 Weather | Twenty-one verified US venue locations using Census address points or attributed OSM stadium bounds, including reviewed official-linked-place reconciliation for Acrisure; ten games with NWS kickoff-hour context in the latest development snapshot; issue/retrieval timestamps, stale/unknown states, compressed source archives | Remaining domestic/international coverage and validated numerical effects |
