...
The deployed `/api/participation-status` route checks participation acquisition and
...
production probe passed in hosted health run `34646352554`; see
`reviews/hosted-production-health.json`. That manually dispatched check does not
establish scheduled reliability.
