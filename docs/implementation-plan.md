...
- [x] Domain contracts: market sign conventions, odds conversions, pushes, probability validation and stale quote rejection. Live quote acquisition and archived observations verified; prospective edge remains unproven.
...
- [x] Production foundations: security headers, social image, sitemap, refresh workflow, consent-controlled analytics integration. Consented production pageview ingestion verified; custom-event reporting remains plan-blocked.
...
- [ ] Publish and verify the staged release after provider cooldown, restore the paused publisher, and demonstrate unattended refresh with retained publication evidence. Publishing credentials are configured.
- [ ] Configure commercial hosting, domain, operator contact and Google publisher approval/consent; verify representative audience measurement beyond QA traffic.
