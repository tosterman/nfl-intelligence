...
The official update schedule says team statistics follow play-by-play updates, generally nightly after game days with corrections later in the week. Its injury-outage paragraph is contradicted by the live September 10 release, which now contains 2025 and 2026 files. The 2026 file has partial team coverage and lacks per-report timestamps; see `reviews/personnel-source-audit.md` for verified bytes and integration constraints. File availability does not establish current player availability. [Official availability schedule](https://nflreadr.nflverse.com/articles/nflverse_data_schedule.html).
