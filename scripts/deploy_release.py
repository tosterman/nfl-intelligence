...
def release_files():
    ...
    for name in ['site.json','weather.json','weather-venues.json','weather-osm-venues.json',
                 'personnel.json','personnel-collection.json','personnel-changes.json','player-usage.json',
                   'quarterbacks.json','quarterback-collection.json','explosive-plays.json','red-zone.json','source-record-changes.json','weekly-matchup-context.json','prior-matchup-context.json']:
