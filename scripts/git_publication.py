...
def main():
    ...
    subprocess.run(['git','add','data/site.json','data/ledger.json','data/source.json','data/weather.json','data/weather-ledger.json','data/weather-sources/','data/quarterbacks.json','data/quarterback-collection.json','data/quarterback-sources/','data/personnel.json','data/personnel-collection.json','data/personnel-sources/'],check=True)
